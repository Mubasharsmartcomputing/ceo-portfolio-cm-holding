        ...
        <section className="bg-white py-24 relative overflow-hidden">
            <div className="max-w-[1241px] mx-auto px-6 lg:px-0">
                ...
                <div className="text-center mb-16 max-w-[800px] mx-auto">
                    ...
                    <p className="font-pathway text-[16px] text-[#4A4A4A] leading-[26px] tracking-wide">
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    {/* Vision Card */}
                    <div className="border border-dashed border-cyan-primary rounded-[20px] p-10 bg-white">
